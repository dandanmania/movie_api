...
//CORS
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'https://dandan-myflix.netlify.app', 'https://main--dandan-myflix.netlify.app', 'localhost:4200'];
app.use(cors({
